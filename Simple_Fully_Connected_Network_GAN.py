...
import matplotlib.pyplot as plt
import numpy as np
gen = joblib.load('GAN_models/generator.pkl')
# gan = joblib.load('gan.pkl')
...
gen = joblib.load('GAN_models/generator.pkl')
dis = joblib.load('GAN_models/discriminator.pkl')
